        ...
        <div class="container">
          <div class="d-flex">
            <a class="header-brand" href="./index.html">
              <img src="" class="header-brand-img" alt="tabler logo" />
            </a>
              ...
              <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                ...
                <li class="nav-item">
                  <a
                    ...
                    class="nav-link"
                    data-toggle="dropdown"
                    ><i class="fe fe-box"></i> Interface</a
                  >
                  <div class="dropdown-menu dropdown-menu-arrow">
                    ...
                    <a href="./pricing-cards.html" class="dropdown-item "
                      >Pricing cards</a
                    >
                  </div>
                </li>
          ...
          <div class="row row-cards">
                    ...
                    <tbody>
                      <tr>
                        <td class="w-1">
                          <span
                            class="avatar"
                            style="background-image: url(./demo/faces/male/9.jpg)"
                          ></span>
                        </td>
                      ...
                      <tr>
                        <td>
                          <span
                            class="avatar"
                            style="background-image: url(./demo/faces/male/4.jpg)"
                          ></span>
                        </td>
                        <td>Bobby Knight</td>
            ...
            <div class="col-md-6">
              <div class="alert alert-primary">
                Are you in trouble?
                <a href="./docs/index.html" class="alert-link"
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <div
                            class="mx-auto chart-circle chart-circle-xs"
                            data-value="0.42"
                            data-thickness="3"
                            data-color="blue"
                          >
                          ...
                          <div class="item-action dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a href="javascript:void(0)" class="dropdown-item"
                                ><i class="dropdown-icon fe fe-tag"></i> Action
                              </a>
                              <a href="javascript:void(0)" class="dropdown-item"
                              ...
                              <a href="javascript:void(0)" class="dropdown-item"
                                ><i
                                  class="dropdown-icon fe fe-message-square"
                                ></i>
      ...
      <div class="container">
        <div class="row align-items-center flex-row-reverse">
          ...
          <div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
            ...
            <a href="https://codecalm.net" target="_blank">codecalm.net</a> All
            rights reserved.
          </div>
        </div>
      </div>
